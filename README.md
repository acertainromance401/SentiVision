...
결과는 예측값이 아니라 전시 해설처럼 제시되며, 현재 저장소는 앱/API 개발을 위한 Python CLI 검증 엔진을 함께 운영합니다.
...
| 앱 | 역할 | 과금 |
|---|---|---|
| iPad 제작 앱 | 드로잉, 감정 전시, 피드백, 아카이브 | 유료 |
| iPhone 감상 앱 | 작품과 감정 전시 카드 감상, 아카이브 탐색 | 무료 |
| 공용 데이터/분석 | 감정 해석, 피드백 반영, 저장 계층 | 공통 |

## About

프로젝트의 제품 방향은 다음과 같습니다.

- 앱 경험: SwiftUI 기반 iPad 드로잉, 감정 전시, 피드백, 아카이브
- 포지션: 유료 프리미엄 앱
- 아카이브 방식: 작품 1점 + 감정 제목 + 해석문을 한 장의 전시 카드로 저장
