...
SentiVision은 개인 창작 사용자가 마음껏 그림을 그리고, 그 과정에서 선택된 색을 바탕으로 감정의 결을 해석받을 수 있는 iPad 우선 프리미엄 앱을 목표로 합니다.
첫 실행에는 개인 프로필, 기준 색상, 기준 감정, 체감 조절을 설정하는 온보딩이 들어가며, 결과는 예측값이 아니라 전시 해설처럼 제시됩니다.
현재 저장소는 iPad 제작 앱, 개인 분포 시각화, 그리고 앱 동작을 검증하는 Python CLI 엔진을 함께 운영합니다.
향후에는 iPhone에서 작품을 감상만 하는 동반 앱을 추가해, 제작과 감상 경험을 분리하는 방향도 열어둡니다.
이 감상용 iPhone 앱은 무료로 제공하고, iPad의 유료 제작 앱으로 이어지는 홍보/전환 경로가 되도록 설계합니다.

| 앱 | 역할 | 과금 |
|---|---|---|
| iPad 제작 앱 | 드로잉, 초기 세팅, 감정 전시, 피드백, 아카이브 | 유료 |
...
- 앱 경험: SwiftUI 기반 iPad 드로잉, 초기 세팅, 감정 전시, 피드백, 아카이브
- 포지션: 유료 프리미엄 앱
- 아카이브 방식: 작품 1점 + 감정 제목 + 해석문 + 개인 분포 흔적을 한 장의 전시 카드로 저장
- 확장 방향: iPhone 감상 전용 companion app
- 전환 구조: 무료 iPhone 감상 앱 -> 유료 iPad 제작 앱
